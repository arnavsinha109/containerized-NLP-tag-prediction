...
2. The text classification model using [FastText](https://fasttext.cc/) in Python. The steps to train and save a FastText text classification model are given here given here - [Supervised Text Classification Model Building](https://fasttext.cc/docs/en/supervised-tutorial.html)
